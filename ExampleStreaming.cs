            ...
            if (result != null && result.results.Length > 0)
            {
                foreach (var res in result.results)
                {
                    foreach (var alt in res.alternatives)
                    {
                        ...
                        if (alt.transcript.Contains("ارض"))
                        {


                            Debug.Log("working!!");
                            GetComponent<Animator>().Play("ارض");
                        }
                        if (alt.transcript.Contains("الحمد لله"))
                        {


                            Debug.Log("working!!");
                            GetComponent<Animator>().Play("الحمدلله");
                          
                        }
                        if (alt.transcript.Contains("ما اسمك"))
                        {


                            Debug.Log("working!!");
                            GetComponent<Animator>().Play("مااسمك");

                        }
                        if (alt.transcript.Contains("احبك"))
                        {


                            Debug.Log("working!!");
                            GetComponent<Animator>().Play("احبك");

                        }
                        if (alt.transcript.Contains("اسف"))
                        {


                            Debug.Log("working!!");
                            GetComponent<Animator>().Play("اسف");
                        ...
                        if (alt.transcript.Contains("لست متاكد"))
                        {


                            Debug.Log("working!!");
                            GetComponent<Animator>().Play("لست متاكد");

                        }
                        if (alt.transcript.Contains("ممتاز"))
                        {


                            Debug.Log("working!!");
                            GetComponent<Animator>().Play("ممتاز");

                        }
                        if (alt.transcript.Contains("لا"))
                        {


                            Debug.Log("working!!");
                            GetComponent<Animator>().Play("لا");
...
public class NewBehaviourScript : MonoBehaviour
{
    ...
    private void OnPhraseRecognized(PhraseRecognizedEventArgs speech)
    {
        ...
        //GetComponent<Animator>().Play(speech.text);
